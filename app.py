...
class ChatApplication:
    ...
    def _setup_main_window(self):
        ...
        # Send button
        send_button = Button(bottom_label, text="Send", font=FONT_BOLD, width=20, bg=BUTTON_COLOR, fg=TEXT_COLOR, command=lambda: self.send_message(None))
        send_button.place(relx=0.77, rely=0.008, relheight=0.03, relwidth=0.22)

        # Record button
        record_button = Button(bottom_label, text="Record", font=FONT_BOLD, width=20, bg=BUTTON_COLOR, fg=TEXT_COLOR, command=self.record_message)
